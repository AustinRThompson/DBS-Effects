...
Box Plot
```{r}
perceptual_BoxPlot(data = listenerRatings |>
                     dplyr::filter(ratingType == "Int"),
                   ylabel = "Intelligibility",
                   norm = FALSE)


ggsave(last_plot(), filename = "Figures/Perceptual Plots/Raw/Int.png",
       height = 4.5,
       width = 7,
       scale = .9)
...
perceptual_BoxPlot(data = listenerRatings |>
                     dplyr::filter(ratingType == "Int"),
                   ylabel = "Intelligibility (Z)",
                   norm = TRUE)

ggsave(last_plot(), filename = "Figures/Perceptual Plots/Z/Int.png",
       height = 4.5,
       width = 7,
       scale = .9)
...
```{r}
perceptual_BoxPlot(data = listenerRatings |>
                     dplyr::filter(ratingType == "LE"),
                   ylabel = "Listening Effort",
                   norm = FALSE)

ggsave(last_plot(), filename = "Figures/Perceptual Plots/Raw/LE.png",
       height = 4.5,
       width = 7,
       scale = .9)
...
perceptual_BoxPlot(data = listenerRatings |>
                     dplyr::filter(ratingType == "LE"),
                   ylabel = "Listening Effort (z)",
                   norm = TRUE)

ggsave(last_plot(), filename = "Figures/Perceptual Plots/Z/LE.png",
       height = 4.5,
       width = 7,
       scale = .9)
```
...
```{r}
perceptual_BoxPlot(data = listenerRatings |>
                     dplyr::filter(ratingType == "VQ"),
                   ylabel = "Voice Quality",
                   norm = FALSE)

ggsave(last_plot(), filename = "Figures/Perceptual Plots/Raw/VQ.png",
       height = 4.5,
       width = 7,
       scale = .9)
...
perceptual_BoxPlot(data = listenerRatings |>
                     dplyr::filter(ratingType == "VQ"),
                   ylabel = "Voice Quality (z)",
                   norm = TRUE)

ggsave(last_plot(), filename = "Figures/Perceptual Plots/Z/VQ.png",
       height = 4.5,
       width = 7,
       scale = .9)
...
listenerRatings  |>
  ...
  dplyr::summarise(VQ = mean(Rating, na.rm = T)) %>%
  dplyr::ungroup() %>%
...
perceptual_BoxPlot(data = listenerRatings |>
                   ...
                   ylabel = "Artic Precision",
                   norm = FALSE)

ggsave(last_plot(), filename = "Figures/Perceptual Plots/Raw/AP.png",
       height = 4.5,
       width = 7,
       scale = .9)
...
perceptual_BoxPlot(data = listenerRatings |>
                     dplyr::filter(ratingType == "AP"),
                   ylabel = "Artic Precision (z)",
                   norm = TRUE)

ggsave(last_plot(), filename = "Figures/Perceptual Plots/Z/AP.png",
       height = 4.5,
       width = 7,
       scale = .9)
```
...
```{r}
perceptual_BoxPlot(data = listenerRatings |>
                     dplyr::filter(ratingType == "Pro"),
                   ylabel = "Prosody",
                   norm = FALSE)

ggsave(last_plot(), filename = "Figures/Perceptual Plots/Raw/Pro.png",
       height = 4.5,
       width = 7,
       scale = .9)
...
ggsave(last_plot(), filename = "Figures/Perceptual Plots/Z/Pro.png",
       height = 4.5,
       width = 7,
       scale = .9)
```
...
ggsave(filename = "Perceptual Measures.png",
...
plotData <- listenerRatings |>
  dplyr::filter(Group == "PD_DBS") |>
  dplyr::group_by(Speaker, Group, DBS_Status, ratingType) |>
  dplyr::summarise(Rating = mean(Rating, na.rm = T)) |>
  dplyr::ungroup() |>
  dplyr::mutate(ratingType = factor(ratingType, levels = c("Int","LE","AP","Pro","VQ")),
...
ggplot(data = plotData) +
  ...
  theme_bw() +
  facet_wrap(~DBS_Status)

ggsave(last_plot(), filename = "Figures/Perceptual Plots/Individual Speakers.png",
       height = 4.5,
       width = 9,
       scale = .9)
```
